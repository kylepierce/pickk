Router.route('/admin/game/:_id', {
  ...
  waitOn: function() {
    return [
      ...
      Meteor.subscribe('singleGameFutureQuestions', this.params._id),
      Meteor.subscribe('singleGameActiveQuestions', this.params._id),
      Meteor.subscribe('singleGamePendingQuestions', this.params._id),
      Meteor.subscribe('singleGameOldQuestions', this.params._id),
