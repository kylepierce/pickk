...
Router.route('/game/:id', {
  ...
  waitOn: function () {
    ...
    return [
      ...
      Meteor.subscribe('answersByGameId', game),
      Meteor.subscribe('activeQuestions', game),
      Meteor.subscribe('activeAtBat', game),
      Meteor.subscribe('atBatPlayer', game),
      Meteor.subscribe('activePlayers', game),
      Meteor.subscribe('gameNotifications', game),
      Meteor.subscribe('leaderboardGamePlayed', game),
      Meteor.subscribe('teams'),
    ]
  },
  data: function () {
